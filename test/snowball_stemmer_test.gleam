...
pub fn stem_test() {
  ...
  "consistory"
  |> snowball_stemmer.stem(stemmer)
  |> should.equal("consistori")

  "kneeling" |> snowball_stemmer.stem(stemmer) |> should.equal("kneel")
  "consolations" |> snowball_stemmer.stem(stemmer) |> should.equal("consol")
  "repeatedly" |> snowball_stemmer.stem(stemmer) |> should.equal("repeat")
  "severely" |> snowball_stemmer.stem(stemmer) |> should.equal("sever")
  "equipped" |> snowball_stemmer.stem(stemmer) |> should.equal("equip")
}
...
pub fn init_word_test() {
  ...
  |> snowball_stemmer.init_word(stemmer)
...
fn after_step0(word: String, stemmer: Stemmer) {
  word
  |> snowball_stemmer.remove_initial_apostrophe
  |> snowball_stemmer.lowercase_and_mark_ys
  |> snowball_stemmer.init_word(stemmer)
...
fn after_step1a(word: String, stemmer: Stemmer) {
  word
  |> after_step0(stemmer)
  |> snowball_stemmer.step1a(stemmer)
}

fn after_step1b(word: String, stemmer: Stemmer) {
  word
  |> after_step1a(stemmer)
  |> snowball_stemmer.step1b(stemmer)
}

fn after_step1c(word: String, stemmer: Stemmer) {
  word
  |> after_step1b(stemmer)
  |> snowball_stemmer.step1c(stemmer)
}

fn after_step2(word: String, stemmer: Stemmer) {
  word
  |> after_step1c(stemmer)
  |> snowball_stemmer.step2
}

fn after_step3(word: String, stemmer: Stemmer) {
  word
  |> after_step2(stemmer)
  |> snowball_stemmer.step3
}

fn after_step4(word: String, stemmer: Stemmer) {
  word
  |> after_step3(stemmer)
...
fn after_step5(word: String) {
  ...
  word
  |> after_step4(stemmer)
  |> snowball_stemmer.step5(stemmer)
}
